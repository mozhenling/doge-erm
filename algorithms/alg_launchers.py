...
from datautils import data_process, bed_datasets as datasets
import copy
import tqdm
import shlex
import hashlib
...
def local_launcher(commands):
    ...
    for cmd in  commands:
        ...
        # subprocess.run('python -m test_torch')
...
def make_args_list(n_trials, dataset_names, algorithms, sub_algorithms, n_hparams_from, n_hparams, steps,
    data_dir, task,skip_model_save, holdout_fraction, is_clean_label,label_flip_p, single_test_envs, hparams):
    args_list = []
            ...
            for algorithm in algorithms:
                ...
                for test_envs in all_test_envs:
                    for hparams_seed in range(n_hparams_from, n_hparams):
                        if algorithm in ['DoYoJo', 'DoYoJoAlpha'] and sub_algorithms !=[]:
                            for sub_algorithm in sub_algorithms:
                                train_args = {}
                                train_args['dataset'] = dataset
                                train_args['algorithm'] = algorithm
                                train_args['sub_algorithm'] = sub_algorithm
                                ...
                                train_args['is_clean_label'] = is_clean_label
                                train_args['label_flip_p'] = label_flip_p
                                train_args['seed'] = data_process.seed_hash(dataset,
